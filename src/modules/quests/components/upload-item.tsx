              ...
              <div className="relative w-[19vw] h-[30vw] lg:w-[9.5vw] lg:h-[14vw] 2xl:w-[8.5vw] 2xl:h-[12vw] overflow-hidden rounded-xl">
                   ...
                   <div className="flex-1 flex flex-col justify-between h-full">
                        <div className="flex flex-col">
                            <h3 className="font-medium text-[2.7vw] lg:text-[1.2vw] 2xl:text-lg pt-3">Upload a random photo</h3>
                       ...
                       
                       {
                        ...
                        isSmallDevice&&(
                            ...
                            <button className="">
                                <Image src='/images/quests/button-upload.svg' width={0} height={0} alt='upload' className='w-[35vw] sm:w-[20vw] lg:w-[10vw] 2xl:w-[7vw] hover-float'/>
                            </button>
