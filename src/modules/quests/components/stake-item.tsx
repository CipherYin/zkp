              ...
              <div className="flex bg-[#FFFBF7] rounded-xl py-8 px-3 lg:p-12 shadow-lg gap-14 w-full">
                   ...
                   <div className="flex-1 flex flex-col justify-between h-full">
                        <div className="flex flex-col">
                            <h3 className="font-medium text-[2.7vw] lg:text-xl pt-3">Stake 10 USDT/USDC</h3>
                       ...
                       
                       {
                        ...
                        isSmallDevice&&(
                            ...
                            <button className="">
                                <Image src='/images/quests/button-stake.svg' width={0} height={0} alt='upload' className='w-[35vw]  sm:w-[20vw] lg:w-[7vw] hover-float'/>
                            </button>
