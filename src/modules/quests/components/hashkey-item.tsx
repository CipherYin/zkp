       ...
       <div className='flex bg-[#D9D9D9] rounded-xl'>
              <div className="flex bg-[#FFFBF7] rounded-xl py-8 p-12 shadow-lg gap-14 w-full">
                   ...
                   <div className="flex-1 flex flex-col justify-between h-full">
                       <h3 className="font-medium text-lg 2xl:text-xl pt-3">Complete Hashkey KYC</h3>
                       <div className="mt-2">
                           <Image src='/images/quests/100xp.svg' width={0} height={0} alt='sxp' className='w-[4vw]'/>
                       </div>
                       <div className="text-gray-600 text-sm mb-4 mt-4">Optional</div>
                       <div className='flex justify-end gap-16 2xl:pt-16 pb-4 rounded-xl items-center'>
                           <button className="">
                               <Image src='/images/quests/button-verify.svg' width={0} height={0} alt='upload' className='w-[7vw] hover-float'/>
                           </button>
