              ...
              <div className="flex bg-[#FFFBF7] rounded-xl py-4 px-3 lg:p-6 2xl:p-12 shadow-lg gap-2 2xl:gap-6 w-full">
                   ...
                   <div className="flex-1 flex flex-col justify-between h-full">
                        <div className="flex flex-col">
                            <h3 className="font-medium text-[2.7vw] lg:text-[1vw] 2xl:text-lg pt-3">Complete Hashkey KYC</h3>
                            <Tooltip content="Tooltip on top-left" position="bottom-left">
                                <div>
                                    <Image src='/images/quests/100xp.svg' width={0} height={0} alt='sxp' className='w-[11vw] lg:w-[3.5vw] 2xl:w-[4vw]'/>
                                </div>
                            </Tooltip>
                       ...
                       
                       {
                        !isSmallDevice&&(
                            ...
                            <button className="">
                                <Image src='/images/quests/button-verify.svg' width={0} height={0} alt='upload' className='w-[16vw] lg:w-[7.5vw]  2xl:w-[7vw] hover-float'/>
                            </button>
                        ...
                        isSmallDevice&&(
                            ...
                            <button className="">
                                <Image src='/images/quests/button-verify.svg' width={0} height={0} alt='upload' className='w-[21vw] sm:w-[20vw] lg:w-[7vw] hover-float'/>
                            </button>
